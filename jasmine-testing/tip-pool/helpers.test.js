describe("Helpers test (with setup and tear-down)", function () {
    ...
    it("should return the correct sum of 'parameter type' in allPayments on sumPaymentTotal()", function () {
        ...
        // add another payment to test multiple values are summing correctly
        ...
        // Now check to make sure summing is correct
    ...
    it("should calculate the correct tip percentage on calculateTipPercent()", function () {
        ...
        // Decimals not allowed and will ask for rounded value
        expect(calculateTipPercent("200", "15.5")).toEqual(8);
    });

    it("should append new td element (having the inner text of 'value') to the tr element fed to the function on appendTd()", function () {
    ...
    it("should append a new td element (having the inner text of 'X' and a classList containing 'delete') to the tr element fed to the function on appendDeleteBtn()", function () {
        let tr1 = document.createElement("tr");
        appendDeleteBtn(tr1);
